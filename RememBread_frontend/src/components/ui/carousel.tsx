...
const CarouselPrevious = forwardRef<HTMLButtonElement, ComponentProps<typeof ButtonUI>>(
...
const CarouselNext = forwardRef<HTMLButtonElement, ComponentProps<typeof ButtonUI>>(
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
